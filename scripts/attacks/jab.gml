...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, sound_get("Jab_1"))
...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, sound_get("Jab_2"))
...
set_window_value(AT_JAB, 8, AG_WINDOW_SFX, sound_get("Jab_3_p1"))
