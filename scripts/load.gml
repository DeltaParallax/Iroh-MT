...
sprite_change_offset("dash", 55, 77);
sprite_change_offset("dashstart", 37, 77);
sprite_change_offset("dashstop", 49, 77);
sprite_change_offset("dashturn", 50, 73);

sprite_change_offset("jumpstart", 53, 75);
...
sprite_change_offset("dattack", 64, 82);
sprite_change_offset("ftilt", 55, 86);
sprite_change_offset("dtilt", 64, 68);
sprite_change_offset("utilt", 64, 104);
sprite_change_offset("nair", 50, 84);
