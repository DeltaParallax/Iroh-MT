...
sprite_change_offset("uphurt", 31, 81);
sprite_change_offset("crouch", 49, 68);
sprite_change_offset("walk", 60, 98);
sprite_change_offset("walkstart", 37, 77);
sprite_change_offset("walkend", 37, 77);
sprite_change_offset("walkturn", 36, 71);
sprite_change_offset("dash", 55, 76);
sprite_change_offset("dashstart", 42, 76);
sprite_change_offset("dashstop", 49, 76);
sprite_change_offset("dashturn", 50, 73);

sprite_change_offset("jumpstart", 53, 74);
...
sprite_change_offset("land", 49, 75);
sprite_change_offset("landinglag", 50, 74);

sprite_change_offset("parry", 61, 69);
...
sprite_change_offset("jab", 64, 78);
sprite_change_offset("dattack", 61, 80);
sprite_change_offset("ftilt", 55, 84);
sprite_change_offset("dtilt", 64, 67);
sprite_change_offset("utilt", 64, 102);
sprite_change_offset("nair", 49, 81);
sprite_change_offset("fair", 64, 94);
sprite_change_offset("bair", 70, 122);
sprite_change_offset("uair", 57, 120);
sprite_change_offset("dair", 50, 86);
...
sprite_change_offset("uspecial", 41, 151);
...
sprite_change_offset("SL_uphurt", 31, 81);
...
sprite_change_offset("SL_fair", 64, 94);
sprite_change_offset("SL_bair", 70, 122);
sprite_change_offset("SL_uair", 68, 120);
sprite_change_offset("SL_dair", 50, 88);
sprite_change_offset("SL_fstrong", 64, 118);
sprite_change_offset("SL_fstrong_charge", 64, 106);
sprite_change_offset("SL_ustrong", 48, 116);
sprite_change_offset("SL_dstrong", 125, 75);
sprite_change_offset("SL_nspecial", 85, 98);
sprite_change_offset("SL_fspecial", 79, 88);
sprite_change_offset("SL_fspecial_air", 79, 88);
sprite_change_offset("SL_uspecial", 43, 168);
